<?php
  ...
  // print order
    ...
    //display CURRENT user's order records from table purchase BUT NOT WORKING...
  ...
  <body>
    ...
    <div class="row">
      ...
      <div class="col-6 px-5">
        <h3 class="p-3" align="center">My Profile</h3>
        <div class="row">
        <div class="form-group col">
          <label class="control-label">First name</label>
          <input class="form-control" type="text" value="try to get this value from DB">
        </div>
        <div class="form-group col">
          ...
          <input class="form-control" type="text" value="">
            ...
            <div class="form-group">
                <div class="py-1">
                  <input type="button" class="btn btn-secondary col-12" value="Save Changes">
                </div>
                  <input type="reset" class="btn btn-outline-dark col-12" value="Cancel">
            </div>
          </div>

          <!--right column-->
          <div class="col-6 px-5">
            <h3 class="p-3" align="center">My Orders</h3>
            <?php
